      ...
      <nav className="container mx-auto px-8 py-4">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <span className="text-4xl md:text-5xl font-light tracking-[0.35em] relative z-10 drop-shadow-[0_4px_24px_rgba(0,0,0,0.15)] dark:drop-shadow-[0_4px_24px_rgba(255,255,255,0.2)]">
              MERKATOX
            </span>
          </Link>
